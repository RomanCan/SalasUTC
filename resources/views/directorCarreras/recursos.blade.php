...
@section('contenido')
    ...
    <div class="container">
        <div id="recurso">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                v-on:click="limpiar()">Cancelar</button>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"
                                v-on:click="agregarRec(id_recurso)">Guardar</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Modal Editar -->
            <div class="modal" id="editarrecurso" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body" style="background-color: #ECEEF0 ">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <label>Id</label>
                                    <input type="text" disabled="" name="descripcion" class="form-control"
                                        v-model="id_recurso" placeholder="id">
                                    <br>
                                    <label>Nombre</label>
                                    <input type="text" name="recurso" class="form-control" v-model="recurso"><br>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                v-on:click="limpiar()">Cancelar</button>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"
                                v-on:click="updateRecurso(id_recurso)">Guardar cambios</button>
                        </div>
                    </div>
                </div>
            </div>
